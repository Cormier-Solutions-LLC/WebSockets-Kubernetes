...
The stack-specific runtime is four source files and approximately 385 lines before comments/tests; canonical HTML, CSS, JavaScript, protocol fixtures, and generated SDK files are excluded. Review this number when functionality changes so adapter duplication stays visible.
