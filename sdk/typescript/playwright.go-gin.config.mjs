...
process.env.REFERENCE_STACK = "Go / Gin";
...
export default defineConfig({
  ...
  workers: 1,
  fullyParallel: false,
  reporter: process.env.CI ? [["line"], ["html", { outputFolder: "../../artifacts/go-gin/playwright-report", open: "never" }]] : "line",
  outputDir: "../../artifacts/go-gin/test-results",
  ...
  webServer: [
    {
      ...
      env: {
        ...
        Redis__InstancePrefix: "cormier:go-gin-tests",
    ...
    },
    {
      ...
      cwd: resolve(repositoryRoot, "examples/go-gin"),
      url: `${frontendOrigin}/health`,
      timeout: 120_000,
      reuseExistingServer: process.env.REFERENCE_REUSE_SERVER === "true",
      env: {
        PORT: "15500", PUBLIC_ORIGIN: frontendOrigin, GATEWAY_URL: gatewayOrigin,
