...
The adapter has 15 stack-specific PHP/configuration/test files and 612 nonblank lines. Generated dependencies, shared assets/fixtures, lock/build metadata, and documentation are excluded. Recalculate after changes.
