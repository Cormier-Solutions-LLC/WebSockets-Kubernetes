...
The adapter has 12 stack-specific Ruby/test files and 407 nonblank lines. Vendored gems, shared assets/fixtures, lock/build metadata, browser harness configuration, and documentation are excluded. Recalculate after changes.
