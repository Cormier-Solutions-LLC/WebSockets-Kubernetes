...
The adapter has nine stack-specific Elixir/config files and 785 nonblank lines, including tests. Shared assets, fixtures, generated SDK, dependency/build metadata, and docs are excluded. Recalculate after changes.
