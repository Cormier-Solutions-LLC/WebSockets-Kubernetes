...
const frontendOrigin = "http://127.0.0.1:15200";
...
export default defineConfig({
  ...
  workers: 1,
  fullyParallel: false,
  reporter: process.env.CI ? [["line"], ["html", { outputFolder: "../../artifacts/java-spring-boot/playwright-report", open: "never" }]] : "line",
  outputDir: "../../artifacts/java-spring-boot/test-results",
  use: {
  ...
  webServer: [
    {
      ...
      env: {
        ...
        Redis__InstancePrefix: "cormier:java-spring-tests",
        Realtime__SessionSource: "Cookie",
        Realtime__AllowedOrigins__0: frontendOrigin,
      },
    },
    {
      command: "java -jar target/java-spring-boot-1.0.3-beta.jar",
      ...
      env: {
        ...
        TOPOLOGY: "non-ha",
        REDIS_INSTANCE_PREFIX: "cormier:java-spring-tests",
