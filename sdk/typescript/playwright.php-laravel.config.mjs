...
export default defineConfig({
  ...
  globalTeardown: "./test/reference-adapters/stop-php-laravel-container.mjs",
  timeout: 30_000,
  expect: { timeout: 8_000 },
  workers: 1,
  fullyParallel: false,
  reporter: process.env.CI ? [["line"], ["html", { outputFolder: "../../artifacts/php-laravel/playwright-report", open: "never" }]] : "line",
  outputDir: "../../artifacts/php-laravel/test-results",
