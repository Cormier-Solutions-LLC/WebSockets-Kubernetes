...
async function buildPackageConsumer() {
  ...
  for (const [packageId, packageFile] of [
    ["Cormier.Realtime.AspNetCore", "Cormier.Realtime.AspNetCore.1.0.1-beta.nupkg"],
    ["Cormier.Realtime.Browser", "Cormier.Realtime.Browser.1.0.1-beta.nupkg"],
    ["Cormier.Realtime.Contracts", "Cormier.Realtime.Contracts.1.0.1-beta.nupkg"],
    ["Cormier.Realtime.Redis", "Cormier.Realtime.Redis.1.0.1-beta.nupkg"],
  ]) {
