...
const image = process.env.RUBY_RAILS_IMAGE ?? "cormier-ruby-rails:local";
process.env.REFERENCE_STACK = "Ruby / Rails";
...
export default defineConfig({
  ...
  globalTeardown: "./test/reference-adapters/stop-ruby-rails-container.mjs",
  timeout: 30_000,
  expect: { timeout: 8_000 },
  workers: 1,
  fullyParallel: false,
  reporter: process.env.CI ? [["line"], ["html", { outputFolder: "../../artifacts/ruby-rails/playwright-report", open: "never" }]] : "line",
  outputDir: "../../artifacts/ruby-rails/test-results",
